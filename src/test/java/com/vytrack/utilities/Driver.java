...
public class Driver {
    ...
    /*
    Making our 'driver' instance private, so that it is not reachable from outside of any class. We make it static, because we want it to run before anything else,
    ...
    /*
    Create utility method which will return same driver instance when we call it.
     */

    public static WebDriver getDriver() {
        if (driver == null) { // if driver/browser was neve opened
